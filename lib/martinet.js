...
function Martinet(options) {
    ...
    console.log('MARTINET: starting pull socket on ' + connection);
...
Martinet.prototype.addWorker = function(name, port) {
    ...
    console.log('MARTINET: starting push socket on ' + connection);
...
Martinet.prototype.execute = function(taskObj, parameters, cb) {
    ...
    Task.create(taskObj).success(function(task) {
        console.log('MARTINET: dispatching task ' + task.id);
...
Martinet.prototype.revoke = function(taskId) {
    ...
    Q.all([
        ...
        console.log('MARTINET: Successfully removed task ' + taskId);
    });
};
...
Martinet.prototype.setProgress = function(taskId, progress) {
    var Task = this.models.Task;
    console.log('MARTINET: task ' + taskId + ' progress ' + 100*progress + '%');
    var self = this;
...
Martinet.prototype.setError = function(taskId, error) {
    console.log('MARTINET: task ' + taskId + ' error: ' + error);
    var Task = this.models.Task;
...
Martinet.prototype.setComplete = function(taskId) {
    console.log('MARTINET: completed task ' + taskId);
    var Task = this.models.Task;
    var self = this;
    Task.find(taskId)
        .success(function(task) {
